...
import com.JuicyShop_NN_Page.OrderHistoryPage;
...
public class OrderCompletionPageTest extends BaseClass{
	...
	public void orderComplete() throws InterruptedException
	{
		...
		String success=orderCompletionPage.successMsg();
		System.out.println(success);
		orderHistoryPage=orderCompletionPage.acctCheck();
